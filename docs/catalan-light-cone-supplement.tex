...
\begin{abstract}
\noindent
This companion document collects additional appendices and proof sketches that
are omitted from the lean arXiv v1 of \emph{The Catalan Light Cone}. It is
interpretation-neutral and intended to preserve auxiliary results and extended
technical development without expanding the main paper.
\end{abstract}
