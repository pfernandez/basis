...
\[
	(M\,N)
	\quad\mapsto\quad
	\input{figures/clc-supp-program-frame-inline.tex}
\]
...
\begin{figure}[h]
	\centering
	\input{figures/clc-supp-fig-MN.tex}
	\caption{A binary application node representing the term $M\,N$.}
\end{figure}

\begin{figure}[h]
	\centering
	\input{figures/clc-supp-fig-Sfgx.tex}
...
\begin{figure}[h]
	\centering
	\input{figures/clc-supp-fig-beta-reduction.tex}
...
\begin{center}
	\input{figures/clc-supp-pairs-tree.tex}
\end{center}
