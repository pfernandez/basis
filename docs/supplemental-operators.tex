...
\providecommand{\mainref}[1]{\ref{#1}}
...
graph-Laplacian constructions (compare Remark~\mainref{rem:dyck-conditioned-drift-scaling}
and Remark~\mainref{rem:dyck-conditioned-kernel-doob} for the tier-growth Markov
